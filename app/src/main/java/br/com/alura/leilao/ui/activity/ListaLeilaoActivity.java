...
public class ListaLeilaoActivity extends AppCompatActivity {
    ...
    private List<Leilao> leiloesDeExemplo() {
        ...
        console.propoe(new Lance(new Usuario("Henrique"), 200));
        console.propoe(new Lance(new Usuario("Luis"), 400));

        Leilao computador = new Leilao("Computador");
        computador.propoe(new Lance(new Usuario("Jorge"), 1200));

        Leilao carro = new Leilao("Carro");
        carro.propoe(new Lance(new Usuario("Luis"), 22000));
        carro.propoe(new Lance(new Usuario("Manuela"), 26000));
        carro.propoe(new Lance(new Usuario("Luis Henrique"), 31000));
